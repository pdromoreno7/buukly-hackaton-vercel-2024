...
Despues de cada parrafo usa dos <br> <br> para generar un salto de linea. No use ** para resaltar enumeraciones no subturlos.solo usa <b> para negrita para esos casos.
