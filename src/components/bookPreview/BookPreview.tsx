...
function BookPreview({
  ...
  return (
    <Wrapper className='flex flex-col py-4 lg:py-16'>
      <div className='flex max-h-[820px] flex-col justify-center gap-12 md:max-h-96 md:flex-row'>
        <div className='mx-auto flex md:mx-0'>
          <CoverBook />
        </div>
        <ScrollArea className='mx-auto h-full max-h-96 max-w-80 rounded-2xl bg-gray-100 p-4 dark:bg-white/5 dark:text-gray-200 md:mx-0'>
